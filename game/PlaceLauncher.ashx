...
switch($request){
	case "RequestGame":
		die(json_encode(["jobId" => "2ea2b52a-1784-4eed-a6f3-7375b13f1a11", "status" => 2, "joinScriptUrl" => $baseUrl . "/Game/join.ashx?placeId=". $placeId ."&joinType=lua", "authenticationUrl" => $baseUrl . "/Login/Negotiate.ashx", "authenticationTicket" => "Guest:" . $UserId], JSON_UNESCAPED_SLASHES | JSON_NUMERIC_CHECK));
		break;
	default:
